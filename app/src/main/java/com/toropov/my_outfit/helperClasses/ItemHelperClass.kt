...
class ItemHelperClass(_postKey: String, _check: Boolean, _image: String, _itemShop: String, _itemName: String, _itemPrice: String, _itemHref: String) {
    ...
    val itemPrice: String = _itemPrice
